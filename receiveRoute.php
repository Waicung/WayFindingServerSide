...
isset($_POST['route_id'])){
    ...
    $start_point_id = $pointUpdator->updatePoint($conn, $start_lat,$start_lng);
    $end_point_id = $pointUpdator->updatePoint($conn,$end_lat,$end_lng);
    //update route
    ...
    $stepCteater->createStep($conn,$route_id,$steps);
